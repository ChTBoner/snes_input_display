            ...
            match event {
                ...
                ControllerEvents::Select => {
                    canvas.copy(
                        ...
                        None, 
                        skin.buttons["select"].rect,
                    )?;
                }
                ControllerEvents::Start => {
                    canvas.copy(
                        &button_texture_start,
                        None, 
                        skin.buttons["start"].rect,
                    )?;
                }
                ControllerEvents::Up => {
                    canvas.copy(
                ...
                ControllerEvents::Left => {
                    canvas.copy(
                        &button_texture_left,
                        None, 
                        skin.buttons["left"].rect,
                    )?;
                }
                ControllerEvents::Right => {
                    canvas.copy(
                        &button_texture_right,
                        None, 
                        skin.buttons["right"].rect,
                    )?;
                }
                ControllerEvents::L => {
                    canvas.copy(
